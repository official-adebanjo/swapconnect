          ...
          <div className="max-w-4xl">
            ...
            >
              <div className="p-2.5 md:p-3 bg-white/10 backdrop-blur-md rounded-xl md:rounded-2xl">
                <Smartphone
                  size={24}
                  className="text-green-400 md:w-8 md:h-8"
                />
              </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6 md:gap-8 items-start">
            ...
            <div className="w-full lg:w-3/4 space-y-6 md:space-y-8">
              ...
              >
                ...
                <div className="mt-8 md:mt-12 p-4 md:p-6 bg-blue-50 dark:bg-blue-900/10 rounded-2xl md:rounded-3xl border border-blue-100 dark:border-blue-900/20 flex gap-3 md:gap-4 items-start">
                  <div className="p-2 bg-blue-200 dark:bg-blue-900/30 rounded-lg md:rounded-xl text-blue-700 dark:text-blue-400 mt-1 shrink-0">
                    <Info size={18} />
                  </div>
                  <div>
                    ...
                    <p className="text-xs md:text-sm text-blue-800 dark:text-blue-300/80 leading-relaxed font-medium opacity-80">
