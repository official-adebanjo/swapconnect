...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="fixed flex flex-col h-screen w-[220px] bg-card text-foreground p-8 shadow-[2px_0_8px_rgba(0,0,0,0.05)] z-100 justify-between border-r border-border">
      <div>
          ...
          <ul className="list-none">
            {menuItems.map((item) => (
              <li key={item.label}>
                <Link
                  href={item.url}
                  className="flex items-center cursor-pointer py-3 px-8 text-[17px] transition-colors duration-200 text-foreground hover:text-brand-primary"
                >
        ...
        <ul className="list-none">
          <li>
            <Link
              ...
              className="flex items-center cursor-pointer py-3 text-[17px] transition-colors duration-200 text-foreground hover:text-brand-primary"
            >
